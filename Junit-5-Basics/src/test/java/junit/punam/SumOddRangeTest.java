...
class SumOddRangeTest {
	...
	public void testSumOdd() {
		assertAll(() -> assertEquals(21, obj.sumOdd(5, 10)), () -> assertEquals(9, obj.sumOdd(1, 5)),
				() -> assertEquals(-1, obj.sumOdd(10, 5)), () -> assertEquals(-1, obj.sumOdd(-5, -10)),
				() -> assertEquals(-1, obj.sumOdd(-15, -10)), () -> assertEquals(-1, obj.sumOdd(-15, 10)),
				() -> assertEquals(-1, obj.sumOdd(15, -10)), () -> assertEquals(-1, obj.sumOdd(0, 10)),
				() -> assertEquals(-1, obj.sumOdd(10, 0)), () -> assertEquals(-1, obj.sumOdd(0, 0)));
	}
